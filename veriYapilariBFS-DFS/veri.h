...
bool DFS(Dugum* agacKok, int deger);	//Ilk derinlik arama fonksiyonu bir agac koku ve aranacak deger parametrelerini alir
bool BFS(Dugum* agacKok, int deger);//Ilk genislik arama fonksiyonu bir agac koku ve aranacak deger parametrelerini alir